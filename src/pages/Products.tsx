...
export function Products() {
  ...
  async function remove(product: ProductRow) {
    if (!confirm(`Delete "${product.name}"? It will be permanently removed from the catalog. Past orders keep their product snapshot.`)) return;
    ...
    if (error) {
      ...
      alert(`Failed to delete "${product.name}". Please try again.`);
      return;
    }
